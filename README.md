...
- Download & extract release bundle: [**Click here to download release bundle **](https://github.com/thedemodrive/keyfactor-istio/releases/download/v2.alpha.1/v2alphal1.zip).
- cd `./v2alpha1`
